...
void CDC_Device_ProcessControlRequest(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo)
{
	...
	switch (USB_ControlRequest.bRequest)
	{
		case CDC_REQ_GetLineEncoding:
			...
			USB_DEBUG_MSG("CDC_REQ_GetLineEncoding");
			break;
		case CDC_REQ_SetLineEncoding:
			...
			USB_DEBUG_PutHEX_U((CDCInterfaceInfo->State.LineEncoding.BaudRateBPS)/57600);
			USB_DEBUG_PutHEX_U(CDCInterfaceInfo->State.LineEncoding.CharFormat );
			USB_DEBUG_PutHEX_U(CDCInterfaceInfo->State.LineEncoding.ParityType);
			USB_DEBUG_PutHEX_U(CDCInterfaceInfo->State.LineEncoding.DataBits);
		...
		case CDC_REQ_SetControlLineState:
			...
			USB_DEBUG_MSG("CDC_REQ_SetControlLineState");
		...
		case CDC_REQ_SendBreak:
			...
			USB_DEBUG_MSG("CDC_REQ_SendBreak");
